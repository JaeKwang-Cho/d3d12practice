...
HRESULT D3D12ResourceManager::CreateVertexBuffer(UINT _sizePerVertex, DWORD _dwVertexNum, D3D12_VERTEX_BUFFER_VIEW* _pOutVertexBufferView, D3D12Resource_ptr* _ppOutBuffer, void* _pInitData)
{
	...
	if (_pInitData) {
		...
		DoFence_forResourceManager();
		WaitForFenceValue_forResourceManager();
	}
...
void D3D12ResourceManager::CreateFence_forResourceManager()
{
...
void D3D12ResourceManager::CleanUpFence_forResourceManager()
{
	if (m_hFenceEvent) {
...
void D3D12ResourceManager::CreateCommandList_forResourceManager()
{
	// 일단 만들기는 하는데
...
UINT64 D3D12ResourceManager::DoFence_forResourceManager()
{
	m_ui64FenceValue++;
...
void D3D12ResourceManager::WaitForFenceValue_forResourceManager()
{
...
void D3D12ResourceManager::CleanUp_forResourceManager()
{
	CleanUpFence_forResourceManager();
}
