...
{
#if 1 // 오프라인 컴파일 여부
	m_Shaders["standardVS"] = d3dUtil::CompileShader(L"Shaders\\03_RenderSmoothly_Shape_Shader.hlsl", nullptr, "VS", "vs_5_1");
	m_Shaders["opaquePS"] = d3dUtil::CompileShader(L"Shaders\\03_RenderSmoothly_Shape_Shader.hlsl", nullptr, "PS", "ps_5_1");
#else
