...
// {
//
//   float4x4 gWVPMat;                  // Offset:    0 Size:    64
//
// }
//
//
...
//   v0.x <- _vin.PosL.x; v0.y <- _vin.PosL.y; v0.z <- _vin.PosL.z; 
//   v1.x <- _vin.Color.x; v1.y <- _vin.Color.y; v1.z <- _vin.Color.z; v1.w <- _vin.Color.w; 
...
//
#line 29 "A:\[DirectX]\MyDirectX\PracticeD3D12\BookPractice\02_Rendering\Shaders\02_Rendering_Shader.hlsl"
mov r0.xyz, v0.xyzx
mov r0.w, l(1.000000)
