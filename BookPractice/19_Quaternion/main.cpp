//***************************************************************************************
// QuaternionApp.cpp by Frank Luna (C) 2015 All Rights Reserved.
//***************************************************************************************
...
public:
	...
	QuaternionApp(const QuaternionApp& _other) = delete;
	QuaternionApp& operator=(const QuaternionApp& _other) = delete;
				   ...
				   _In_ PSTR cmdLine, _In_ int showCmd)
{
	...
	try
	{
		QuaternionApp theApp(hInstance);
...
QuaternionApp::QuaternionApp(HINSTANCE hInstance)
	: D3DApp(hInstance)
{
...
void QuaternionApp::CreateRtvAndDsvDescriptorHeaps()
{
...
void QuaternionApp::Update(const GameTimer& _gt)
{
...
void QuaternionApp::Draw(const GameTimer& _gt)
{
...
void QuaternionApp::OnMouseDown(WPARAM _btnState, int _x, int _y)
{
...
void QuaternionApp::OnMouseUp(WPARAM _btnState, int _x, int _y)
{
	// 마우스를 놓는다.
	ReleaseCapture();
}

void QuaternionApp::OnMouseMove(WPARAM _btnState, int _x, int _y)
{
...
void QuaternionApp::OnKeyboardInput(const GameTimer _gt)
{
...
void QuaternionApp::AnimateMaterials(const GameTimer& _gt)
{
}

void QuaternionApp::UpdateObjectCBs(const GameTimer& _gt)
{
...
void QuaternionApp::UpdateMaterialBuffer(const GameTimer& _gt)
{
...
void QuaternionApp::UpdateShadowTransform(const GameTimer& _gt)
{
...
void QuaternionApp::UpdateMainPassCB(const GameTimer& _gt)
{
...
void QuaternionApp::UpdateShadowPassCB(const GameTimer& _gt)
{
...
void QuaternionApp::UpdateSsaoCB(const GameTimer& _gt)
{
...
void QuaternionApp::BuildRootSignature()
{
...
void QuaternionApp::BuildSsaoRootSignature()
{
...
void QuaternionApp::BuildDescriptorHeaps()
{
...
void QuaternionApp::BuildShadersAndInputLayout()
{
	...
	m_Shaders["standardVS"] = d3dUtil::CompileShader(L"Shaders\\19_Quaternion.hlsl", nullptr, "VS", "vs_5_1");
	m_Shaders["opaquePS"] = d3dUtil::CompileShader(L"Shaders\\19_Quaternion.hlsl", nullptr, "PS", "ps_5_1");
...
void QuaternionApp::BuildStageGeometry()
{
...
void QuaternionApp::BuildSkullGeometry()
{
...
void QuaternionApp::BuildFrameResources()
{
...
void QuaternionApp::BuildMaterials()
{
...
void QuaternionApp::BuildRenderItems()
{
	UINT objCBIndex = 0;
...
void QuaternionApp::DrawRenderItems(ID3D12GraphicsCommandList* _cmdList, const std::vector<RenderItem*>& _renderItems, D3D_PRIMITIVE_TOPOLOGY _Type)
{
...
void QuaternionApp::DrawSceneToShadowMap()
{
...
void QuaternionApp::DrawNormalsAndDepth()
{
...
std::array<const CD3DX12_STATIC_SAMPLER_DESC, 11> QuaternionApp::GetStaticSamplers()
{
