...
void TessellationApp::UpdateWavesGPU(const GameTimer& _gt)
{
...
void TessellationApp::BuildWavesCSRootSignature()
{
...
void TessellationApp::BuildWavesCSGeometry()
{
...
void TessellationApp::BuildLandGeometry()
{
...
void TessellationApp::BuildFenceGeometry()
{
	GeometryGenerator geoGen;
